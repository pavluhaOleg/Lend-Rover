...
import bw from './CarsBlockWindow.module.css'
import { BlockImgCars } from '../../../../Infa-arr/InfaArr'
...
const CarsBlockWindow: FC<ICarProps> = ({ carActive }) => {

  const [modelHover] = useState<ICarBlockmg[]>(BlockImgCars)
      ...
      {modelHover.map(elem =>
        ...
        >
          <div className={bw.blockКeview}>
            ...
            <p className={`${bw.linkKeviw} ${bw.marginTop}`}>семейство ленд ровер</p>
          </div>
...
export default CarsBlockWindow